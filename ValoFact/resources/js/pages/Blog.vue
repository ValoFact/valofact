<template>
    <div class="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <div class="container mx-auto p-4">
        <h1 class="text-4xl font-bold text-green-800 mb-8">Latest Blog Posts</h1>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="p-6">
              ...
              <router-link
                :to="`/blog/${post.id}`"
                class="mt-4 inline-block bg-green-500 text-white px-4 py-2 rounded-full hover:bg-green-600 transition-all"
              >
                Read More
              </router-link>
            </div>
